[![Run App Blake Callahan](https://github.com/Junkifii/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Junkifii/GithubActions/actions/workflows/run-app.yaml)
